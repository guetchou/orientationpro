      ...
      <div className="mx-auto max-w-7xl px-6 py-14">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_3fr]">
          <div className="max-w-sm">
            ...
            <p className="mt-4 text-sm font-medium text-emerald-300">makoki.org</p>
          </div>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-slate-800 pt-6 text-sm text-slate-400 sm:flex-row sm:items-center sm:justify-between">
          <p>© {currentYear} MAKOKI. Tous droits réservés.</p>
          <p>Conçu pour le contexte congolais, avec une adaptation locale progressive et documentée.</p>
        </div>
      </div>
    </footer>
  );
