...
const ROUTES = [
  ...
  { method: 'GET', path: `/api/v1/ats/jobs/${JOB_ID}/applications` },
  { method: 'GET', path: `/api/v1/ats/jobs/${JOB_ID}/events` },
  { method: 'GET', path: `/api/v1/ats/jobs/${JOB_ID}/recruiters` },
  { method: 'POST', path: `/api/v1/ats/applications/${APPLICATION_ID}/evaluations` },
  { method: 'GET', path: `/api/v1/ats/applications/${APPLICATION_ID}/evaluations` },
