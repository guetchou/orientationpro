...
MySQL, Docker et GitHub Actions. Les Vagues 3 et 4 ne sont pas fusionnées :
leurs futurs contrats ne sont ni audités ni validés ici.
...
| Profil / projet de vie | lecture ou écrasement inter-Compte | filtre `accountId` Profil v1 | V3 absent |
...
nulle sur V3/V4 absentes. Une compilation ou une CI verte ne prouve pas
