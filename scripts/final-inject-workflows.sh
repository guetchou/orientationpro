...
echo "🚀 Injection Finale des Workflows N8N"

# Configuration
N8N_URL="http://localhost:5678"
API_KEY="orientationpro-n8n-api-key-1752987465"
...
# Main execution
echo -e "${BLUE}🚀 Démarrage de l'injection finale des workflows...${NC}"
...
echo ""
echo -e "${GREEN}🎉 Injection finale des workflows terminée !${NC}"
