...
echo "🚀 Activation des Workflows N8N - Maintenant que le conteneur est prêt"

# Configuration
N8N_URL="http://localhost:5678"
API_KEY="orientationpro-n8n-api-key-1752986126"
...
# Main execution
echo -e "${BLUE}🚀 Démarrage de l'activation des workflows...${NC}"
...
echo ""
echo -e "${GREEN}🎉 Activation des workflows terminée !${NC}"
